...
const UserTypeCard = ({  icon, title, description, selected, onClick }: { type: string, icon: React.ReactNode, title: string, description: string, selected: boolean, onClick: () => void }) => (
  <motion.div
