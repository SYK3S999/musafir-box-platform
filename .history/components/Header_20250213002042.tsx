    ...
    >
      <div className="container flex h-16 items-center px-4 sm:px-6 lg:px-8">
        <div className="mr-4 flex items-center flex-1">
          {/* Logo is now shown regardless of authentication status */}
            <Link href="/" className="mr-4 sm:mr-10 flex items-center space-x-2">
            <Image 
              src="/Musafer.png" 
              alt="musaferBox Logo" 
              width={100} 
              height={30} 
              className="w-24 sm:w-20 h-auto !block ml-0" // Force visibility and move to the left
              priority
            />
            </Link>
  ...
  return (
    <div className="min-h-screen bg-background pt-6 pb-20">
      <div className="px-6 pb-6 mb-6 border-b">
        {/* Logo in mobile menu is now shown regardless of authentication status */}
