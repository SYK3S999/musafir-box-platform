...
// ... getNavItems function remains the same ...
  ...
  return (
    ...
    >
      <div className="container flex h-16 items-center px-4 sm:px-6 lg:px-8">
        {/* Logo section with explicit display styles */}
        <div className="mr-4 flex items-center flex-1">
          <div className="flex-shrink-0 block"> {/* Added explicit display block */}
            <Link href="/" className="mr-4 sm:mr-8 flex items-center space-x-2">
              <Image 
                ...
                width={100}
                height={30} 
                className="w-16 sm:w-20 h-auto block" // Added block display
                priority
                style={{ display: 'block' }} // Added inline style to ensure visibility
              />
            </Link>
          </div>
      ...
      <div className="px-6 pb-6 mb-6 border-b">
        <Link href="/" className="mr-4 sm:mr-8 flex items-center space-x-2 relative group">
          <Image 
            ...
            width={120} 
            height={40} 
            className="w-24 sm:w-32 block" // Added block display
            style={{ display: 'block' }} // Added inline style to ensure visibility
          />
        </Link>
      </div>
