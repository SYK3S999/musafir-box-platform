...
const Footer = () => {
  ...
  return (
    <motion.footer
      className="relative bg-primary-gradient text-primary-foreground overflow-hidden"
      initial="hidden"
      animate="visible"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-12">
          ...
          <motion.div className="lg:col-span-5 space-y-6 sm:space-y-8" variants={itemVariants}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="backdrop-blur-md bg-white/5 rounded-2xl p-4 hover:bg-white/10 transition-all duration-300">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 mt-1 text-primary-foreground/70" />
                  <div>
                    <h4 className="font-medium mb-1">Visit Us</h4>
                    <p className="text-sm text-primary-foreground/70">123 Travel Street, World</p>
                  </div>
                </div>
              </div>
              <div className="backdrop-blur-md bg-white/5 rounded-2xl p-4 hover:bg-white/10 transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-primary-foreground/70">contact@musaferBox.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              {["facebook", "instagram", "twitter"].map((platform) => (
                ...
                >
                  ...
                  <div className="relative bg-white/10 p-3 rounded-lg backdrop-blur-sm group-hover:bg-white/20 transition-all duration-300">
          ...
          >
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="group flex items-center text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-300"
                    >
                      <span className="w-8 h-[1px] bg-primary-foreground/40 group-hover:w-12 group-hover:bg-primary-foreground transition-all duration-300 mr-2" />
                      {link.name}
                    </Link>
                  </li>
                ))}
                ...
                {[
                  ...
                  <li key={item.category}>
                    <Link
                      ...
                      className="group flex items-center gap-3 text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-300"
                    >
            ...
            <div className="space-y-6">
              ...
              <p className="text-primary-foreground/80">Subscribe to receive travel updates and exclusive offers.</p>
              <div className="space-y-3">
                <div className="relative">
                  <input
                    type="email"
                    placeholder="Enter your email"
                    className="w-full px-4 py-2.5 rounded-xl bg-white/5 dark:bg-black/5 backdrop-blur-sm border border-white/10 dark:border-white/5 focus:border-white/20 dark:focus:border-white/10 outline-none transition-colors duration-300 text-primary-foreground dark:text-primary-foreground placeholder:text-primary-foreground/50 dark:placeholder:text-primary-foreground/30"
                  />
                </div>
                <button className="w-full px-4 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-sm transition-colors duration-300 font-medium text-primary-foreground">
                  Subscribe
                </button>
              </div>
            </div>
