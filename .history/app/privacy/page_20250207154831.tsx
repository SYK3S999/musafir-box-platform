    ...
    <div className="container mx-auto px-6 py-12">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <p className="text-lg mb-6">
          At Voyageur, we are committed to protecting your privacy and ensuring the security of your personal
        ...
        <p className="text-lg">
          If you have any questions about this Privacy Policy, please contact us at privacy@voyageur.com.
        </p>
      </motion.div>
    </div>
  )
