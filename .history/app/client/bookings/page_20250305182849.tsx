...
export default function BookingsPage() {
  ...
  // Load bookings and watch for changes
  useEffect(() => {
    const loadBookings = () => {
    ...
    // Add event listener for storage changes (in case bookings are updated from another tab)
  ...
  const handleViewBooking = (bookingId: string) => {
    // Find the booking and store it in sessionStorage
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="flex items-center gap-3 bg-primary/5 p-3 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{booking.offer.destination}</p> {/* Fixed to show destination instead of category */}
                      </div>
                    </div>
