...
// ... (keep all other existing code until renderConfirmationStage)

const renderConfirmationStage = (selectedOffer: number | null, bookingId: string | null, bookingDetails: { travelers: number; travelDate: Date | null; specialRequests: string }) => {
  ...
  const renderConfirmationStage = (selectedOffer: number | null, bookingId: string | null, bookingDetails: { travelers: number; travelDate: Date | null; specialRequests: string} ) => {
    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground">Present this Booking ID to the agency when you arrive.</p>
      </motion.div>
    )
  }
  ...
  return (
    <ProtectedRoute allowedRoles={["client"]}>
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        {bookingStage === "confirmation" && renderConfirmationStage(selectedOffer, bookingId, bookingDetails)}
      </div>
    </ProtectedRoute>
  )
}
