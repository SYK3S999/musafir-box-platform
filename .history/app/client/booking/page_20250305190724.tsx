...
function BookingPageContent() {
  ...
  const agencyOffers = [
    {
      id: 1,
      agency: searchParams.get("agency") || "Wanderlust Adventures",
      location: "123 Traveler's Lane, New York, NY 10001",
      destination: searchParams.get("title") || "Paris, France",
      duration: "5 days",
  ...
  const handleBookingConfirmation = () => {
    ...
    if (selectedOfferData) {
      ...
      console.log("Booking data to save:", bookingData) // Log before saving

      // Save to localStorage
      try {
        const existingBookings = JSON.parse(localStorage.getItem("bookings") || "[]")
        console.log("Existing bookings:", existingBookings) // Log current state
        const updatedBookings = [...existingBookings, bookingData]
        localStorage.setItem("bookings", JSON.stringify(updatedBookings))
        console.log("Updated bookings saved to localStorage:", updatedBookings) // Log after saving
      } catch (error) {
      ...
      console.log("Bookings after save (read back):", savedBookings)
