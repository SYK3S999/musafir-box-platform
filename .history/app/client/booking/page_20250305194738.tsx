...
function BookingPageContent() {
  ...
  const [selectedOffer, setSelectedOffer] = useState<number | null>(offerId || null)
  const [bookingStage, setBookingStage] = useState<"browse" | "details" | "confirmation">(
    offerId ? "details" : "browse"
  )
  ...
  const [isSubmitting, setIsSubmitting] = useState(false) // Added for UX feedback
  ...
  const agencyOffers = [
    {
      ...
      duration: "7 days",
      price: 1999,
      highlights: ["Beach Relaxation", "Snorkeling", "Luxury Resort Stay"],
    ...
    },
    {
      ...
      duration: "7 days",
      price: 1799,
      highlights: ["Mount Fuji Day Trip", "Tokyo City Tour", "Tea Ceremony"],
      inclusions: ["4-Star Hotel", "Most Meals", "Japan Rail Pass"],
    },
    {
      id: 3,
      agency: "Sacred Journeys",
      location: "789 Adventure Road, London, UK",
      destination: "Paris, France",
      duration: "5 days",
      price: 1299,
      highlights: ["Eiffel Tower Tour", "Seine River Cruise", "Louvre Visit"],
  ...
  const handleBookingConfirmation = () => {
    ...
    if (selectedOfferData) {
      const bookingData = {
        ...
        status: "Pending",
        offer: {
          title: searchParams.get("title") || selectedOfferData.destination,
          category: searchParams.get("category") || "package",
          destination: selectedOfferData.destination,
        },
        details: {
          travelers: bookingDetails.travelers,
          travelDate: bookingDetails.travelDate.toISOString(),
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="grid lg:grid-cols-3 md:grid-cols-2 gap-4">
      {agencyOffers.map((offer) => (
        <motion.div
          ...
          title={`Book ${offer.destination} with ${offer.agency}`} // UX: Tooltip
        >
    ...
    return (
      <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <label className="block mb-2 text-muted-foreground" htmlFor="travelers">Number of Travelers</label>
            <div className="relative">
              ...
              <input
                ...
                aria-label="Number of travelers" // Accessibility
              />
            </div>
          </div>
          <div>
            <label className="block mb-2 text-muted-foreground" htmlFor="travelDate">Travel Date</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-primary/20"
                aria-label="Select travel date" // Accessibility
              />
            </div>
          </div>
        </div>
        ...
        <div>
          <label className="block mb-2 text-muted-foreground" htmlFor="specialRequests">Special Requests</label>
          <textarea
            id="specialRequests"
            ...
            aria-label="Enter special requests" // Accessibility
          />
        </div>
        ...
        <div className="flex gap-4">
          <button
            ...
            title="Confirm your booking" // UX: Tooltip
          >
          ...
          <Button
            ...
            className="w-full"
            title="Return to offers list" // UX: Tooltip
          >
            Back to Offers
          </Button>
        </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-1 bg-primary/5 p-6">
              <div className="text-center">
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent imitation mb-6">
                  Booking Confirmed!
                </h2>
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    <motion.div
                      ...
                      title={step} // UX: Tooltip for full text
                    >
                ...
                <div className="mt-auto pt-6 flex justify-between items-center">
                  ...
                  <Button
                    ...
                    title="View all your bookings" // UX: Tooltip
                  >
                    Go to Bookings
                  </Button>
                </div>
