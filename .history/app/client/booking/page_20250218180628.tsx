...
function BookingPageContent() {
  ...
  useEffect(() => {
    if (offerId) {
      console.log("Offer ID from URL:", offerId); // Debugging
      setSelectedOffer(Number(offerId)); // Convert offerId to a number
      setBookingStage("details"); // Automatically go to the details stage if offerId is present
    }
  }, [offerId]);
  ...
  const handleBookingConfirmation = () => {
    ...
    router.push(`/client/bookings?bookingId=${newBookingId}`)
  }
