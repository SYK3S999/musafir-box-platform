...
import { Compass, MapPin, Plus, Minus, Globe, Calendar, Users, ScrollText, ArrowRight, Sparkles, Loader2, Plane, Hotel, Car, Utensils, Camera, Wallet } from "lucide-react"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={(value: any[]) => setBudget({...budget, flexibility: value[0]})}
                    min={0}
                    max={50}
                    step={5}
                    className="mt-2"
