...
export default function TravelAlonePage() {
  ...
  const calculateEstimatedCost = useCallback(() => {
    ...
    const daysOfTrip = dateRange?.to && dateRange?.from ? Math.ceil(
    ...
    return (basePerDay * daysOfTrip + accommodationCost + activitiesCost + transportationCost + accessibilityCost) * travelers
        ...
        <Card className="inline-block">
          <CardContent className="pt-6">
            ...
            <p className="text-3xl font-bold text-primary">
              {budget.currency} {calculateEstimatedCost()?.toLocaleString() ?? 'N/A'}
            </p>
