        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-center p-12">
          ...
          >
            ...
            <ValueCard
              ...
              content="We're dedicated to creating unforgettable journey experiences"
            />

            <ValueCard
              icon={Users}
              title="Customer Satisfaction"
              content="Your happiness and comfort are our top priorities"
            />

            <ValueCard
              icon={Leaf}
              title="Sustainability"
              content="Committed to environmentally responsible travel practices"
            />

            <ValueCard
              icon={Lightbulb}
              title="Innovation"
              content="Constantly improving our services with cutting-edge solutions"
            />
          </motion.div>
        </div>
      </div>
