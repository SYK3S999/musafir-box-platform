...
const InputWithIcon = ({ icon, label, id, type = "text", required = true, value, onChange }: { icon: React.ReactNode, label: string, id: string, type?: string, required?: boolean, value: string, onChange: (e: React.ChangeEvent<HTMLInputElement>) => void }) => (
  <motion.div
...
export default function Register() {
  ...
  const validateForm = () => {
    ...
    if (step === 3 && userType === "agency") {
      if (!formData.agency_name || !formData.license_number || !formData.agency_address) {
        toast({
          title: "Missing Agency Details",
          description: "Please complete all agency information",
          variant: "destructive"
        })
        return false
      }
        ...
        return (
          <div className="space-y-6">
            <InputWithIcon 
              icon={<User className="w-5 h-5" />}
              label="Username"
              id="username" value={""} onChange={function (e: React.ChangeEvent<HTMLInputElement>): void {
            ...
            <InputWithIcon 
              ...
              label="Password"
              id="password"
              type="password" value={""} onChange={function (e: React.ChangeEvent<HTMLInputElement>): void {
                throw new Error("Function not implemented.")
              } }            />
            <InputWithIcon 
              icon={<Lock className="w-5 h-5" />}
        ...
        return userType === "agency" ? (
          <div className="space-y-6">
            <InputWithIcon 
              icon={<Building2 className="w-5 h-5" />}
              label="Agency Name"
              id="agency-name" value={""} onChange={function (e: React.ChangeEvent<HTMLInputElement>): void {
                throw new Error("Function not implemented.")
              } }            />
            <InputWithIcon 
              icon={<Key className="w-5 h-5" />}
              label="License Number"
              id="license" value={""} onChange={function (e: React.ChangeEvent<HTMLInputElement>): void {
                throw new Error("Function not implemented.")
              } }            />
            <InputWithIcon 
              icon={<MapPin className="w-5 h-5" />}
              label="Agency Address"
              id="agency-address" value={""} onChange={function (e: React.ChangeEvent<HTMLInputElement>): void {
                throw new Error("Function not implemented.")
              } }            />
          </div>
        ) : null
