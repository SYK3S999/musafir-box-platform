    ...
    <div className="container mx-auto px-6 py-12">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <p className="text-lg mb-6">
          Welcome to musaferBox. By using our website and services, you agree to comply with and be bound by the following
          terms and conditions of use.
        </p>
        <h2 className="text-2xl font-bold mb-4">1. Acceptance of Terms</h2>
        <p className="mb-6">
          By accessing or using musaferBox&apos;s services, you agree to be bound by these Terms of Service and all applicable
        ...
        <p className="mb-6">
          You agree to use musaferBox&apos;s services only for lawful purposes and in a way that does not infringe the rights
        ...
        <p className="mb-6">
          Your use of musaferBox&apos;s services is also governed by our Privacy Policy. Please review our Privacy Policy,
        ...
        <p className="mb-6">
          musaferBox reserves the right to modify these terms at any time. We will always post the most current version on
