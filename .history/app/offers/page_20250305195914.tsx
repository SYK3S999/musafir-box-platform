    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <p className="text-muted-foreground">Please log in to add items to your wishlist.</p>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <p className="text-muted-foreground">Please log in to book this offer.</p>
          <div className="flex justify-end space-x-2">
            <Button variant="outline" onClick={onClose}>Cancel</Button>
            <Button onClick={() => router.push("/login")}>Log In</Button>
          </div>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <p className="text-muted-foreground">You need to be a client to book this offer.</p>
          <div className="flex justify-end space-x-2">
...
function OfferCard({ 
  ...
  const [isBooking, setIsBooking] = useState(false) // Added for UX feedback
  ...
  const handleBookNowClick = () => {
    setIsBooking(true)
    onBookNow(offer)
    setTimeout(() => setIsBooking(false), 1000) // Reset after 1s
  }
  ...
  return (
    <motion.div
      ...
      title={`${offer.title} - ${offer.description}`} // Accessibility: Tooltip-like info
    >
      <div className="relative">
        ...
        <button
          ...
          title={isWishlisted ? "Remove from wishlist" : "Add to wishlist"} // UX: Clear action intent
        >
          <Heart 
      ...
      <div className="p-6 pt-0">
        <button 
          ...
          title="Start booking this offer"
        >
...
function OffersContent() {
  ...
  const [isLoadingFilters, setIsLoadingFilters] = useState(false) // Added for UX
  ...
  const filteredOffers = useMemo(() => {
    ...
    setTimeout(() => setIsLoadingFilters(false), 300) // Simulate filter processing
    return result
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="relative col-span-2">
            ...
            <input
              ...
              aria-label="Search travel offers by destination" // Accessibility
            />
          </div>
          <div className="col-span-1">
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-primary/20 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                aria-label="Filter by price range" // Accessibility
              >
          ...
          <div className="col-span-1">
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-primary/20 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                aria-label="Filter by difficulty level" // Accessibility
              >
            ...
            {categories.map((category) => {
              ...
              return (
                <motion.button
                  ...
                  `}
                  title={`Filter by ${category.label}`} // UX: Tooltip
                >
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              <select
                ...
                aria-label="Sort offers" // Accessibility
              >
            ...
            <motion.button
              ...
              title="View your saved wishlist" // UX: Tooltip
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-secondary text-secondary-foreground px-4 py-2 rounded-xl flex items-center gap-2 hover:bg-secondary/80 transition-all"
              title="Reset all filters" // UX: Tooltip
            >
              <X className="w-4 h-4" />
              Clear Filters
            </motion.button>
