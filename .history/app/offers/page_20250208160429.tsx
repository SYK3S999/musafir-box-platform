        ...
        {filteredOffers.length === 0 ? (
          ...
          >
            {filteredOffers.map((offer) => {
              ...
              // Use the first image, with a fallback to the second if the first fails
                ...
                >
                  <div className="relative">
                    <Image 
                      ...
                      height={400}
                      onError={(e) => {
                        // If primary image fails, use secondary image
                  ...
                  <div className="p-6 pt-0">
                    <button className="w-full bg-primary text-primary-foreground py-3 rounded-xl hover:bg-primary/90 transition-colors flex items-center justify-center gap-2">
